...
#include "qt/rapids/createproposaldialog.h"
#include "qt/rapids/forms/ui_createproposaldialog.h"
...
CreateProposalDialog::CreateProposalDialog(RapidsGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 RPD");
