...
static bool getDisclaimerDialogResult()
{
    ...
    "The protocol and transaction processing rules for the Assets are still under "
    ...
    "EXPERIMENTAL. Your wallet data, bitcoins and Assets tokens may be lost, "
    ...
    "PLEASE DO NOT use wallet(s) with significant amounts of bitcoins or Assets "
